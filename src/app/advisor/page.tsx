...
function getPriorityBorder(p: Tip['priority']) {
  switch (p) {
    case 'high': return 'border-e-[oklch(0.62_0.22_27)]'
    case 'medium': return 'border-e-[oklch(0.72_0.18_55)]'
    case 'low': return 'border-e-[oklch(0.65_0.18_250)]'
  }
}
      ...
      {!tips.length
        ...
        : (
          <div className="flex flex-col gap-3">
            {tips.map((tip, i) => (
              <div key={i} className={`bg-[oklch(0.16_0.01_250)] border border-[oklch(0.25_0.01_250)] border-e-2 ${getPriorityBorder(tip.priority)} rounded-xl px-5 py-4`}>
